...
from .views import home, registerA,registerM, dashboardA , dashboardM , logout, addPropertyM , searchPropertyM , showProperty , otpM , uploadA , uploadM ,  editProfileA , editProfileM 
urlpatterns = [
    path('', home, name='home'),
